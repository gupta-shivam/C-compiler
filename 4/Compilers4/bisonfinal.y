...
list_var : id_arr
{
	$$ = add_new_node("list_var",$1);
		...
		| id_arr EQ mathexpr
{
	$$ = add_new_node("list_var",$1,$2,$3);
} 
		|id_arr COMMA list_var 
{
	$$ = add_new_node("list_var",$1,$2,$3);
}	
	...
	| mathexpr
{
	...
	;
init : id_arr EQ constructor
{
	$$ = add_new_node("init",$1,$2,$3);	
}
	   |
{
	$$ = add_new_node("init");	
